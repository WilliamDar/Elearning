            ...
            <div class="home_slider_container">
                ...
                <div class="owl-carousel owl-theme home_slider">
                    ...
                    <div class="owl-item">
                        ...
                        <div class="home_slider_background" style="background-image:url({{asset('images/index.jpg')}})"></div>
                        <div class="home_container">
                            <div class="container">
                                <div class="row">
                                    <div class="col">
                                        <div class="home_content text-center">
                                            <div class="home_logo"><img src="{{asset('images/home_logo.png')}}" alt="">
                                            </div>
                                            <div class="home_text">
                                ...
                                <div class="col-lg-6 featured_col">
                                    <div class="featured_content">
                                        ...
                                        <div class="featured_footer d-flex align-items-center justify-content-start">
                                            <div class="featured_author_image"><img src="{{asset('images/featured_author.jpg')}}"
                                                    alt=""></div>
                    ...
                    <div class="col">
                        ...
                        <div class="courses_slider_container">
                            <div class="owl-carousel owl-theme courses_slider">
                                ...
                                <div class="owl-item">
                                    <div class="course">
                                        <div class="course_image"><img src="{{asset('images/course_1.jpg')}}" alt="">
                                        </div>
                                ...
                                <div class="owl-item">
                                    <div class="course">
                                        <div class="course_image"><img src="{{asset('images/course_2.jpg')}}" alt="">
                                        </div>
                                        <div class="course_body">
                                            <div
                                                class="course_header d-flex flex-row align-items-center justify-content-start">
                                            ...
                                            <div class="course_text">Maecenas rutrum viverra sapien sed ferm entum.
                                                Morbi tempor odio eget lacus tempus pulvinar.</div>
                                            <div class="course_footer d-flex align-items-center justify-content-start">
                                                <div class="course_author_image"><img src="{{asset('images/course_author_2.jpg')}}"
                                                        alt=""></div>
                                    ...
                                    <div class="course">
                                        ...
                                        <div class="course_body">
                                            ...
                                            <div class="course_text">Maecenas rutrum viverra sapien sed ferm entum.
                                                Morbi tempor odio eget lacus tempus pulvinar.</div>
                                            <div class="course_footer d-flex align-items-center justify-content-start">
                                                <div class="course_author_image"><img src="{{asset('images/course_author_3.jpg')}}"
                                                        alt=""></div>
